...
class ProductPage(BasePage): 
    ...
    def should_be_successful_addition(self):
        item_name_alert = self.is_element_present(*ProductPageLocators.ITEM_NAME_ALERT)
        item_name = self.is_element_present(*ProductPageLocators.ITEM_NAME)
    ...
    def should_be_same_cost(self):
        item_price_alert = self.is_element_present(*ProductPageLocators.ITEM_PRICE_ALERT)
        item_price = self.is_element_present(*ProductPageLocators.ITEM_PRICE)
